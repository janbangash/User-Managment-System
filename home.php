  		...
  		<div class="col-lg-12">
  			<?php if ($verified == 'Not Verified'): ?>
  				<div class="alert alert-danger alert-dismissible text-center mt-2 m-0"> 
  					...
  					<strong>Your E-mail is not verified
  					! We have sent you an E-mail verification link on your E-mail, Please check and verify now! </strong>
  				</div>
  			<?php endif; ?>
...
<!-- Start Edit Note Modal -->
  ...
  <script type="text/javascript">
  	$(document).ready(function(){
  		...
  		// Display Note of user in Details Ajax Request
